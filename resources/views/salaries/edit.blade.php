    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold text-primary mb-0">Edit Data Gaji</h2>
            ...
            <form action="{{ route('salaries.update', $salary->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="bulan" value="{{ $salary->bulan }}" class="form-control shadow-sm" required>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-semibold">Gaji Pokok</label>
                    <input type="number" name="gaji_pokok" value="{{ $salary->gaji_pokok }}" class="form-control shadow-sm" step="0.01" required>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-semibold">Tunjangan</label>
                    <input type="number" name="tunjangan" value="{{ $salary->tunjangan }}" class="form-control shadow-sm" step="0.01">
                </div>

                <div class="mb-4">
                    <label class="form-label fw-semibold">Potongan</label>
                    <input type="number" name="potongan" value="{{ $salary->potongan }}" class="form-control shadow-sm" step="0.01">
                </div>
